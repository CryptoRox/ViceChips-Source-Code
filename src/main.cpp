...
const string strMessageMagic = "ViceChips Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ViceChips", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Tue, 04 Nov 2014 13:57:31 GMT";
        CTransaction txNew;
        txNew.nTime = 1415109451;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1415109451;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1938933;
		if(fTestNet)
        {
            block.nNonce   = 1938933;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xd00d395ace366cce84c6720e23fedcc45743322cef861b035050ff54333192ec"));
        block.print();
